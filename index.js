// code was taken on Mikhail's class in december 2021 (https://github.com/mikhail-cct/ssp-practical/blob/main/index.js)
...
router.use(express.static(path.resolve(__dirname,'view'))); //We serve static content from "views" folder
...
router.get('/get/html', function(req, res) {
    ...
    let xml = fs.readFileSync('MobileInk.xml', 'utf8'),
        xsl = fs.readFileSync('MobileInk.xsl', 'utf8');
...
router.post('/post/json', function (req, res) {
    ...
    function appendJSON(obj) {
        ...
        XMLtoJSON('MobileInk.xml', function (err, result) {
            ...
            JSONtoXML('MobileInk.xml', result, function(err){
